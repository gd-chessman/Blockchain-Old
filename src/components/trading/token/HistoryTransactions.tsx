...
export default function HistoryTransactions({ orders = [], historyTransactionsRef, tokenAddress , className, maxHeight = '31.25rem'}: { orders?: any[], historyTransactionsRef: any, tokenAddress: any, className?: string, maxHeight?: string }) {
    const { t } = useLang();
